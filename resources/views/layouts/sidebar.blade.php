...
<div id="sidebar">
	...
	@if($feed)
		...
		<p style="margin-top: 5px;"><span class="dot @if($feed->type == 'danger') dot-danger @else dot-success @endif""></span> @if($feed->type == 'danger') Offline @else Online @endif - <span id="MyClockDisplay"></span> (LOCAL Time)</p>
		</div>
	@endif
	...
	<div class="box @if($OnlineStatus == 0) box-danger @else box-success @endif" style="height: 80px !important;">
		...
		<p class="dot @if($OnlineStatus == 0) dot-danger @else dot-success @endif""><p>@if($OnlineStatus == 0) {{'Not Online'}} @else {{'Online'}} @endif</span>
