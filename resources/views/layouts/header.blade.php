<nav class="navbar navbar-default top-header">
  ...
  <div class="navbar-left mb-top-header">
    ...
    <div class="mb-header-ctrl desktop-hide">
      ...
      <div class="mb-logo">
        <a href="{{route('home')}}">
          <img src="{{url('vendor/ecutech-code/images/logo-white.png')}}" alt="logo" width="80" height="60">
  ...
  <div class="navbar-right mb-bottom-header">
    ...
    <ul class="nav navbar-nav">
      @if(!Auth::user()->is_admin())
        <li class="m-r-8">
            <button class="btn btn-warning redirect-click" data-redirect="{{route('cart')}}"> <span style="background: #4cae4c; color: white; padding: 2px 0px 2px 5px; border-radius: 5px; margin-right: 5px;"> {{\Cart::total(0)}} </span> <i class="fa fa-cart-shopping"></i> Cart</button>
        </li>
        @endif
        <li>
