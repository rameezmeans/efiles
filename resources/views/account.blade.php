                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                      <div class="form-group" style="margin-bottom:19px">
                                          <label for="exampleInputType1">Account Type</label>
                                              <div>
                                                  <span class="m-r-10"><input name="status" value="company" type="radio" @if($user->status == 'company') checked @endif > Company</span>
                                                  <span class="m-r-10"><input name="status" value="private" type="radio" @if($user->status == 'private') checked @endif  > Private</span>
                                                  <span><input type="radio" name="status" value="entrepreneur_microentreprise" @if($user->status == 'entrepreneur_microentreprise') checked @endif > Auto Entrepreneur / Microentreprise</span>
                                              </div>
                                      </div>
                                    </div>
                                  </div>
